DEFAULT_CONFIG = {
    ...
    "instructions": {
        ...
        "how_to_use_the_transcript": [
            ...
            "For emoji-only or very short comments, use the transcript creatively to ask a specific, engaging question about a moment or idea from the video. Reference a specific scene, line, or turn of phrase. Make the commenter feel like you both watched the same thing together.",
            "Vary your engagement strategies for emoji-only comments. Do not always ask 'which part resonated' or 'which moment was it'. Sometimes reference a specific funny or moving moment from the transcript. Sometimes ask about their personal connection. Sometimes make a playful observation. Keep the page from looking repetitive."
        ],
        ...
        "comment_type_handling": {
            "emoji_only_or_very_short": """Short and engaging reply that pulls something specific from the video transcript.
    ...
    "examples": [
        ...
        },
        {
            ...
            "model_reply": "Deepa, इतने सारे emojis तो तब निकलते हैं जब कोई बात सीधे अंदर जा के बैठ जाए 😄 क्या था वो moment?"
        },
        {
        ...
        {
            "comment": "abhineet__13\n😂😂😂😂",
            "model_reply": "Abhineet, वो आंटी जी ने खुद बोला ना कि 'मुझे शर्म आती है' और हँसने लगीं 😂 उस हँसी में बहुत कुछ था!"
        },
        {
            "comment": "saraswati332002\nMeri to 90 percent life change hogyi aapko sun kr .... acharye prashant ji",
            "model_reply": "Saraswati, और 10% के लिए क्या plan है? 😄🙏"
        },
        {
        ...
        {
            "comment": "m00nlitdreams Aacharya jii ko mai 2019 se hi sun rhi hu or unki bato ko follow krte krte khud main itni capable ho gyi ki bahri duniya ka asar nhi hota❤️🙌iss duniya mai ldkiyo ko itna confidence dene wale sacche sarthi ho✨",
