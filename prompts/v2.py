    ...
    "instructions": {
        ...
        "two_registers": {
            ...
            "quiet_and_grounded": "Use this when the comment touches something genuinely heavy: grief, trauma, abuse, "
                                  ...
                                  "Just acknowledge briefly and hold the moment. A single warm sentence or even a 🙏 "
        ...
        Not suitable for emoji-only comments, casual praise, deep emotional comments, or anyone who seems to just be 
        passing through. Also not suitable for: pure grief reactions (multiple 😢 emojis, "sach me," short sad responses) 
        on videos about violence, abuse, or trauma; comments from someone describing active suffering; 
