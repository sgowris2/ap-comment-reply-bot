DEFAULT_CONFIG = {
    ...
    "mode_suffixes": {
        "serious": """ACTIVE MODE: SERIOUS
- Register is locked to quiet_and_grounded.
- No funniness or joking around. This is a sensitive topic and the tone should reflect that.
- One or two sentences only. Presence over insight.
""",
        "regular": """ACTIVE MODE: REGULAR
- Proceed with all defaults as specified above.
"""
    },
